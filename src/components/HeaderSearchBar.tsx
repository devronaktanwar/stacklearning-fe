      ...
      <div className="flex justify-center text-sm items-center gap-4 flex-col lg:flex-row w-full">
        <div className="flex flex-col w-full lg:flex-row">
          <div className="inline-flex items-center p-3 lg:py-5 py-3 gap-5 bg-[#f9fafc] lg:border-none w-full border-b">
            ...
            <input type="text" placeholder="Search keywords" className="bg-transparent w-full lg:w-[180px]"/>
          </div>
        ...
        <div className="w-full">
          <button className="px-5 lg:py-4  py-2 text-white rounded-full bg-primaryNew flex items-center gap-2 w-full justify-center"><IoSearch/>Search</button>
        </div>
      </div>
    </div>
  );
